...
const DATA = [
  {
    ...
    project: {
      name: "그로스핏 애널리틱스",
      desc: "신입 프론트엔드 개발자로서 마케팅분석 솔루션인 그로스핏 애널리틱스를 개발했습니다. 개발 초기 단계부터 팀에 합류하여  베타버전까지 성공적으로 런치하였습니다. 초기 스타트업이다보니 직원수가 적어, 클라이언트 영역은 혼자 작업하였으며 그래프나 대쉬보드 등으로 데이터 시각화하는 작업을 주로 하였습니다.",
